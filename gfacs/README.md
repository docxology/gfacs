...
The GFACS Thin-Orchestrator is a comprehensive experiment runner that executes simulations across all 8 GFACS combinatorial optimization problems, automatically collecting and organizing all outputs (configurations, logs, data, visualizations, and animations) in a single structured output directory.
