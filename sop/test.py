...
if __name__ == "__main__":
    ...
    dirname = os.path.dirname(args.path) if args.path is not None else f'../pretrained/sop/{args.nodes}/no_model'
    os.makedirs(dirname, exist_ok=True)

    result_filename = f"test_result_ckpt{filename}-sop{args.nodes}-ninst{args.size}-nants{args.n_ants}-niter{args.n_iter}-seed{args.seed}"
